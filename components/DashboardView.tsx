...
const DashboardView: React.FC<DashboardViewProps> = ({ history, testTopics, activeExamType }) => {
    const [activeExamFilter, setActiveExamFilter] = useState<ExamType | 'All'>(activeExamType || 'All');
