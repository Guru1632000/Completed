...
const Hero: React.FC<HeroProps> = ({ onResumeTest, onShowWeeklyPerformance, activeExamType }) => {
    ...
    const stats = [
        ...
        { value: 3, label: 'Major Exams Supported', suffix: '+' },
    ];
    ...
    return (
        <div className="relative overflow-hidden pt-24 pb-20 md:pt-32 md:pb-28">
            ...
            <button
                onClick={onShowWeeklyPerformance}
                className="absolute left-0 top-1/2 -translate-y-1/2 z-20 bg-purple-600/80 backdrop-blur-sm text-white font-semibold py-4 px-2 rounded-r-lg shadow-lg hover:bg-purple-500/90 transition-all duration-300 transform hover:scale-105"
                style={{ writingMode: 'vertical-rl', textOrientation: 'mixed' }}
                aria-label="View Weekly Performance"
            >
                Weekly Performance
            </button>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-4xl text-center mx-auto">
                    ...
                    <p className="mt-6 max-w-xl mx-auto text-lg text-gray-400 stagger-animated-entry stagger-3">
                     ...
                     <p className="mt-4 max-w-2xl mx-auto text-base text-purple-300/90 stagger-animated-entry stagger-4">
                        Questions are prepared based on real exam standards for TNPSC, Bank, and Railway exams, covering both Prelims and Mains levels.
                    </p>
                    ...
                    >
                        <a href="#syllabus" className="btn btn-primary">
                           Get Started
                ...
                {/* STATS SECTION */}
                <div 
                    className="mt-24 max-w-5xl mx-auto stagger-animated-entry"
