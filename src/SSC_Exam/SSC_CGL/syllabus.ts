...
Matrix
Statement, Argument & Courses of Action`,
  maths: `Number System
L.C.M and H.C.F
Surds and Indices
...
Regular Right Pyramid with triangular or square base`,
  english: `Noun
Pronoun
Verb Forms, Syntax, Modals and Tenses
Adjectives
Adverbs
Prepositions
Conjunctions
...
Sentence Improvement and Spelling Correction
Misspelt or Inappropriate Words
Idioms / Phrases
...
// --- Tier 2 Syllabus Text ---
const sscCglTier2SyllabusText = {
  maths: `Computation of Whole Numbers
...
Network and Information Security Threats (hacking, viruses, worms, Trojans, etc.)
Preventive Measures`,
};

// Tier 1 - Create individual GA units
const sscCgl1Geography: SyllabusUnit = { id: 'ssc-cgl1-geo', title: 'Tier 1 - Geography', topics: createTopicsForUnit('Tier 1 - Geography', parseSscTopics(sscGeographyText)) };
const sscCgl1History: SyllabusUnit = { id: 'ssc-cgl1-hist', title: 'Tier 1 - History of India', topics: createTopicsForUnit('Tier 1 - History of India', parseSscTopics(sscHistoryOfIndiaText)) };
const sscCgl1Culture: SyllabusUnit = { id: 'ssc-cgl1-culture', title: 'Tier 1 - Culture', topics: createTopicsForUnit('Tier 1 - Culture', parseSscTopics(sscCultureText)) };
const sscCgl1Awards: SyllabusUnit = { id: 'ssc-cgl1-awards', title: 'Tier 1 - Awards and Honors', topics: createTopicsForUnit('Tier 1 - Awards and Honors', parseSscTopics(sscAwardsAndHonorsText)) };
const sscCgl1Constitution: SyllabusUnit = { id: 'ssc-cgl1-const', title: 'Tier 1 - Constitution of India', topics: createTopicsForUnit('Tier 1 - Constitution of India', parseSscTopics(sscConstitutionOfIndiaText)) };
const sscCgl1Sports: SyllabusUnit = { id: 'ssc-cgl1-sports', title: 'Tier 1 - Sports', topics: createTopicsForUnit('Tier 1 - Sports', parseSscTopics(sscSportsText)) };
const sscCgl1Economics: SyllabusUnit = { id: 'ssc-cgl1-econ', title: 'Tier 1 - Economics', topics: createTopicsForUnit('Tier 1 - Economics', parseSscTopics(sscEconomicsText)) };
const sscCgl1Physics: SyllabusUnit = { id: 'ssc-cgl1-phy', title: 'Tier 1 - Physics', topics: createTopicsForUnit('Tier 1 - Physics', parseSscTopics(sscPhysicsText)) };
const sscCgl1Chemistry: SyllabusUnit = { id: 'ssc-cgl1-chem', title: 'Tier 1 - Chemistry', topics: createTopicsForUnit('Tier 1 - Chemistry', parseSscTopics(sscChemistryText)) };
const sscCgl1Biology: SyllabusUnit = { id: 'ssc-cgl1-bio', title: 'Tier 1 - Biology', topics: createTopicsForUnit('Tier 1 - Biology', parseSscTopics(sscBiologyText)) };
const sscCgl1Books: SyllabusUnit = { id: 'ssc-cgl1-books', title: 'Tier 1 - Books', topics: createTopicsForUnit('Tier 1 - Books', parseSscTopics(sscBooksText)) };

// Tier 2 - Create individual GA units
const sscCgl2Geography: SyllabusUnit = { id: 'ssc-cgl2-geo', title: 'Tier 2 - Geography', topics: createTopicsForUnit('Tier 2 - Geography', parseSscTopics(sscGeographyText)) };
const sscCgl2History: SyllabusUnit = { id: 'ssc-cgl2-hist', title: 'Tier 2 - History of India', topics: createTopicsForUnit('Tier 2 - History of India', parseSscTopics(sscHistoryOfIndiaText)) };
const sscCgl2Culture: SyllabusUnit = { id: 'ssc-cgl2-culture', title: 'Tier 2 - Culture', topics: createTopicsForUnit('Tier 2 - Culture', parseSscTopics(sscCultureText)) };
const sscCgl2Awards: SyllabusUnit = { id: 'ssc-cgl2-awards', title: 'Tier 2 - Awards and Honors', topics: createTopicsForUnit('Tier 2 - Awards and Honors', parseSscTopics(sscAwardsAndHonorsText)) };
const sscCgl2Constitution: SyllabusUnit = { id: 'ssc-cgl2-const', title: 'Tier 2 - Constitution of India', topics: createTopicsForUnit('Tier 2 - Constitution of India', parseSscTopics(sscConstitutionOfIndiaText)) };
const sscCgl2Sports: SyllabusUnit = { id: 'ssc-cgl2-sports', title: 'Tier 2 - Sports', topics: createTopicsForUnit('Tier 2 - Sports', parseSscTopics(sscSportsText)) };
const sscCgl2Economics: SyllabusUnit = { id: 'ssc-cgl2-econ', title: 'Tier 2 - Economics', topics: createTopicsForUnit('Tier 2 - Economics', parseSscTopics(sscEconomicsText)) };
const sscCgl2Physics: SyllabusUnit = { id: 'ssc-cgl2-phy', title: 'Tier 2 - Physics', topics: createTopicsForUnit('Tier 2 - Physics', parseSscTopics(sscPhysicsText)) };
const sscCgl2Chemistry: SyllabusUnit = { id: 'ssc-cgl2-chem', title: 'Tier 2 - Chemistry', topics: createTopicsForUnit('Tier 2 - Chemistry', parseSscTopics(sscChemistryText)) };
const sscCgl2Biology: SyllabusUnit = { id: 'ssc-cgl2-bio', title: 'Tier 2 - Biology', topics: createTopicsForUnit('Tier 2 - Biology', parseSscTopics(sscBiologyText)) };
const sscCgl2Books: SyllabusUnit = { id: 'ssc-cgl2-books', title: 'Tier 2 - Books', topics: createTopicsForUnit('Tier 2 - Books', parseSscTopics(sscBooksText)) };

// --- Tier 1 Syllabus Units ---
export const SSC_CGL_TIER1_SYLLABUS: SyllabusUnit[] = [
    { id: 'ssc-cgl1-reason', title: 'Tier 1 - General Intelligence & Reasoning', topics: createTopicsForUnit('Tier 1 - General Intelligence & Reasoning', parseSscTopics(sscCglTier1SyllabusText.reasoning)) },
    sscCgl1Geography,
    sscCgl1History,
    sscCgl1Culture,
    sscCgl1Awards,
    ...
    sscCgl1Biology,
    sscCgl1Books,
    { id: 'ssc-cgl1-maths', title: 'Tier 1 - Quantitative Aptitude', topics: createTopicsForUnit('Tier 1 - Quantitative Aptitude', parseSscTopics(sscCglTier1SyllabusText.maths)) },
    { id: 'ssc-cgl1-eng', title: 'Tier 1 - English Comprehension', topics: createTopicsForUnit('Tier 1 - English Comprehension', parseSscTopics(sscCglTier1SyllabusText.english)) },
];

// --- Tier 2 Syllabus Units ---
export const SSC_CGL_TIER2_SYLLABUS: SyllabusUnit[] = [
    { id: 'ssc-cgl2-maths', title: 'Tier 2 - Mathematical Abilities', topics: createTopicsForUnit('Tier 2 - Mathematical Abilities', parseSscTopics(sscCglTier2SyllabusText.maths)) },
    { id: 'ssc-cgl2-reason', title: 'Tier 2 - Reasoning and General Intelligence', topics: createTopicsForUnit('Tier 2 - Reasoning and General Intelligence', parseSscTopics(sscCglTier2SyllabusText.reasoning)) },
    { id: 'ssc-cgl2-eng', title: 'Tier 2 - English Language and Comprehension', topics: createTopicsForUnit('Tier 2 - English Language and Comprehension', parseSscTopics(sscCglTier2SyllabusText.english)) },
    sscCgl2Geography,
    sscCgl2History,
    sscCgl2Culture,
    sscCgl2Awards,
    ...
    sscCgl2Biology,
    sscCgl2Books,
    { id: 'ssc-cgl2-comp', title: 'Tier 2 - Computer Knowledge', topics: createTopicsForUnit('Tier 2 - Computer Knowledge', parseSscTopics(sscCglTier2SyllabusText.computer)) },
];
